...
:sparkling_heart: :blue_heart: :grimacing: :sparkles:".replace(':','').split(' ')

INPUT_FILE_NAME = 'sentiment140_text_preprocessed'
OUTPUT_FOLDER_PATH = '/content/drive/MyDrive/Capstone/data'
FILE_NAME = '{}_emoji_labeled.csv'.format(INPUT_FILE_NAME)

OUTPUT_PATH = os.path.join(OUTPUT_FOLDER_PATH, FILE_NAME)

text_feather = pd.read_feather('/content/drive/MyDrive/Capstone/data/{}.ftr'.format(INPUT_FILE_NAME))
    ...
    for prob in [prob]:
        ...
        for i, t in enumerate(tqdm(TEST_SENTENCES)):
            if i < len(tokenized):
                ...
                t_score.extend([EMOJIS[ind] for ind in ind_top])
        ...
        with open(OUTPUT_PATH, 'a') as csvfile:
            ...
            writer.writerow(['Text', 'Top5%',
                            'Emoji_1_ind', 'Emoji_2_ind', 'Emoji_3_ind', 'Emoji_4_ind', 'Emoji_5_ind',
...
output_csv.to_feather('/content/drive/MyDrive/Capstone/data/{}_emoji_labeled.ftr'.format(INPUT_FILE_NAME))